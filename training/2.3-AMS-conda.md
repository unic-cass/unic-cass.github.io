...
> bash ~/miniconda.sh -b -p $HOME/eda/unic-cass
...
{: .no_toc }
##### 3. Install the tools and IHP-SG13g2 pdks

{: .shellcmd}
> ```bash
> conda install -c unic-cass xschem netgen magic ngspice open_pdks.ihp-sg13g2 klayout
> ```

{: .cmdout}
> ```
> (base) cass@unic-cass:~$ conda install -c unic-cass xschem netgen magic ngspice open_pdks.ihp-sg13g2 klayout
> 
